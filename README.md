...
public class Medusa
{
    ...
    {
        string Discord = "sou1society";
        string Télégram = "madeyoureset_off";

        return new Tuple<string, string, string>(Discord, Telegram);
    }

    public static Tuple<string, List<string>, int, string> Me()
    {
        string Name = "S.....";
        List<string> Speak = new List<string> { "French", "English" };
        int Age = 19;
        string Year = "2006";
